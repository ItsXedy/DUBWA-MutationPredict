...
MainFrame.ClipsDescendants = true -- CRITICAL FIX: Cuts off anything floating outside the circle
...
ToggleButton.MouseButton1Click:Connect(function()
	...
	if minimized then
		-- Hard-hide internal content modules completely
		ContentFrame.Visible = false
		ManualRefreshButton.Visible = false
		DestroyButton.Visible = false
		
		-- Morph main framing properties cleanly into a standalone circle button
		MainFrame.Size = UDim2.new(0, 45, 0, 45)
		TitleBar.Size = UDim2.new(1, 0, 1, 0)
		MainUICorner.CornerRadius = UDim.new(1, 0)
		TitleUICorner.CornerRadius = UDim.new(1, 0)
		
		-- Re-center emoji presentation strictly inside the bubble
		TitleText.Text = "⏳"
		TitleText.Size = UDim2.new(1, 0, 1, 0)
		TitleText.TextXAlignment = Enum.TextXAlignment.Center
		
		-- Expand invisible trigger button bounds across the entire circle interface
		ToggleButton.Position = UDim2.new(0, 0, 0, 0)
		ToggleButton.Size = UDim2.new(1, 0, 1, 0)
		ToggleButton.Text = ""
	else
		-- Re-expand layout sizing properties seamlessly back to a crisp menu panel
		MainFrame.Size = UDim2.new(0, 260, 0, 245)
		TitleBar.Size = UDim2.new(1, 0, 0, 35)
		MainUICorner.CornerRadius = UDim.new(0, 10)
		TitleUICorner.CornerRadius = UDim.new(0, 10)
		...
		-- Unhide operational frame views safely
...
local function updateUIStrings()
	-- CRITICAL SYSTEM CHECK: Drop line formatting calculations entirely if user is minimized
	if minimized then 
		clearLabels()
		return 
	end
...
-- Background loop process orchestration
task.spawn(function()
	while true do
